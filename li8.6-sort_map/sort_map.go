...
/*
unsorted:
Key: alpha, Value: 34 / Key: golf, Value: 34 / Key: hotel, Value: 16 / Key: juliet, Value: 65 / Key: kilo, Value: 43 / Key: bravo, Value: 56 / Key: charlie, Value: 23 / Key: delta, Value: 87 / Key: echo, Value: 56 / Key: foxtrot, Value: 12 / Key: indio, Value: 87 / Key: lima, Value: 98 / 
sorted:
